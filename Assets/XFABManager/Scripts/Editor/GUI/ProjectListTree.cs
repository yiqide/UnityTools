...
namespace XFABManager
{
    public class ProjectListTree : TreeView
    {
        ...
        private ListShowProjects listProject;
        ...
        public ProjectListTree(TreeViewState state, MultiColumnHeaderState mchs, EditorWindow window,ListShowProjects listProject) : base(state, new MultiColumnHeader(mchs))
        {
            m_Mchs = mchs;
            showBorder = true;
        ...
        protected override void DoubleClickedItem(int id)
        {
            ...
            listProject.OpenProject(project);
        }
